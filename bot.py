...
Name = [["곽성은","김도연","김민성","김수민","김정빈","김하진","박서우","박수현","안도윤","오은찬","윤효상","이어진","이주희","이철욱","정승현","정태경","정혜인","채정현","최경호","현준하"],
        ...
        ["","","","","","","","","",""],
        ["","","","","","","","","","",""]]
statsdict = {'2104' : (1, 1), '2417' : (1, 1), '2321' : (0.96073717948718, 3), '2402' : (0.954365079365079, 4), '2201' : (0.950396825396825, 5), '2118' : (0.944749694749695, 6), '2216' : (0.94047619047619, 7), '2309' : (0.94047619047619, 7), '2316' : (0.938034188034188, 9), '2109' : (0.936507936507937, 10), '2119' : (0.936507936507937, 10), '2107' : (0.93543956043956, 12), '2106' : (0.933760683760684, 13), '2415' : (0.928571428571429, 14), '2311' : (0.883814102564103, 15), '2115' : (0.869467338217338, 16), '2404' : (0.859661172161172, 17), '2414' : (0.858058608058608, 18), '2302' : (0.830357142857143, 19), '2317' : (0.817765567765568, 20), '2406' : (0.79265873015873, 21), '2112' : (0.782699938949939, 22), '2418' : (0.781746031746032, 23), '2410' : (0.764995421245421, 24), '2105' : (0.748931623931624, 25), '2113' : (0.748015873015873, 26), '2303' : (0.746260683760684, 27), '2405' : (0.746184371184371, 28), '2408' : (0.717338217338217, 29), '2205' : (0.709401709401709, 30), '2401' : (0.703983516483516, 31), '2306' : (0.682348901098901, 32), '2420' : (0.679372710622711, 33), '2116' : (0.67609126984127, 34), '2407' : (0.673344017094017, 35), '2217' : (0.662660256410256, 36), '2110' : (0.662393162393162, 37), '2413' : (0.660943223443223, 38), '2312' : (0.636981074481074, 39), '2210' : (0.611568986568987, 40), '2219' : (0.610844017094017, 41), '2213' : (0.590277777777778, 42), '2203' : (0.58974358974359, 43), '2310' : (0.588637057387057, 44), '2206' : (0.577190170940171, 45), '2211' : (0.576007326007326, 46), '2212' : (0.574786324786325, 47), '2208' : (0.56486568986569, 48), '2313' : (0.557959401709402, 49), '2314' : (0.556852869352869, 50), '2103' : (0.548344017094017, 51), '2319' : (0.52785409035409, 52), '2214' : (0.507287851037851, 53), '2318' : (0.491414835164835, 54), '2108' : (0.461500305250305, 55), '2308' : (0.448450854700855, 56), '2320' : (0.43349358974359, 57), '2412' : (0.426205738705739, 58), '2207' : (0.386179792429792, 59), '2304' : (0.364850427350427, 60), '2220' : (0.362713675213675, 61), '2215' : (0.362408424908425, 62), '2416' : (0.358440170940171, 63), '2202' : (0.322000915750916, 64), '2411' : (0.301739926739927, 65), '2120' : (0.294261294261294, 66), '2114' : (0.289797008547009, 67), '2305' : (0.282051282051282, 68), '2409' : (0.279876373626374, 69), '2102' : (0.245726495726496, 70), '2111' : (0.22275641025641, 71), '2301' : (0.211271367521367, 72), '2403' : (0.205891330891331, 73), '2218' : (0.199671855921856, 74), '2204' : (0.197115384615385, 75), '2209' : (0.193376068376068, 76), '2117' : (0.182959401709402, 77), '2419' : (0.169604700854701, 78), '2101' : (0.12900641025641, 79), '2307' : (0.0908119658119658, 80), '2315' : (0.0178571428571429, 81)}
...
def input_seat(): # 좌석 번호 입력 함수
    ...
    yourstats=""
    if stid!="none" and stid[0]=="2": yourstats="[통계 결과]\n"+"기간 : 3월 1주차~4월 4주차(총 8주)\n"+"학번 : "+stid+"\n평균 참여율 : "+statsdict[stid][0]+"\n순위 : "+statsdict[stid][1]+"/80"
    res={
            "version": "2.0",
            "template": {
                "outputs": [
